...
export const SUBMENUS = {
  mindBody: { name: 'Mind & Body', sub: 'Work on self-improvement', icon: 'meditate', items: [
    ...
    item('gym', 'Gym', 'Build strength', 14, { health: 4, looks: 2, happiness: 1 }, 'You kept up a steady gym routine.', { icon: 'gym', cost: 40 }),
    ...
    item('library', 'Library', 'Study in peace', 6, { smarts: 2 }, 'You spent the afternoon studying at the library.', { icon: 'library' }),
    item('martialArts', 'Martial Arts', 'Discipline and balance', 8, { health: 3, happiness: 2 }, 'You practiced martial arts and earned a new belt stripe.', { icon: 'martial', cost: 60 }),
    item('meditate', 'Meditate', 'Calm your thoughts', 10, { happiness: 4, health: 1 }, 'You took quiet time to meditate.', { icon: 'meditate' }),
    item('memory', 'Memory', 'Sharpen your mind', 6, { smarts: 2, happiness: 1 }, 'You played memory games and beat your record.', { icon: 'memory' }),
